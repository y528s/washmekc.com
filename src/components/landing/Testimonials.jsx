// Three testimonials. Specific names, specific neighborhoods, specific outcomes.
// All copy is placeholder — must be replaced with real reviews before launch.
        ...
        {TESTIMONIALS.map((t, i) => (
          ...
          >
            ...
            <figcaption className="mt-6 flex items-center gap-3">
              {/* Avatar placeholder — TODO: replace with real headshot or initials avatar from review platform */}
              <span
                aria-hidden="true"
                className="grid h-11 w-11 place-items-center rounded-full bg-brand/10 text-brand font-display font-bold text-sm"
              >
                {t.initials}
              </span>
              <span>
