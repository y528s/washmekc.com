// Problem / agitation / solution. Three short, sensory vignettes that mirror
// what the homeowner actually sees pulling into their driveway.
      ...
      <ul className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
        {VIGNETTES.map((v, i) => (
          ...
          >
            ...
            <h3 className="mt-4 font-display font-bold text-[19px] leading-snug text-ink">
              {v.title}
            </h3>
