          ...
          {FAQS.map((item, i) => {
            ...
            return (
              <li key={item.q}>
                ...
                <div id={panelId} role="region" aria-labelledby={buttonId} hidden={!open} className="px-5 sm:px-7 pb-6 sm:pb-7 -mt-1">
                  <p className="text-[15.5px] sm:text-[16px] leading-relaxed text-slatey max-w-3xl">{item.a}</p>
                </div>
              </li>
            );
          })}
