// Sticky header. Wordmark left, phone + CTA right. No nav menu by design —
  ...
  return (
    <header
      className={`sticky top-0 z-40 w-full transition-all duration-200 ${
        scrolled
          ? "bg-bg/90 backdrop-blur border-b border-black/5"
...
// Simple SVG wordmark placeholder — water drop + brand-blue type.
// TODO: replace with finalized logo asset once the brand designer ships it.
function Wordmark() {
  return (
    <span className="flex items-center gap-2">
      ...
      >
        <path
          d="M13 2.5C13 2.5 5 11 5 16.5a8 8 0 0 0 16 0C21 11 13 2.5 13 2.5Z"
          fill="#1E3A5F"
        />
        <path
          d="M11 17.5c-1.4 0-2.5-1.1-2.5-2.5"
          stroke="#FAFAF7"
          strokeWidth="1.6"
          strokeLinecap="round"
        />
