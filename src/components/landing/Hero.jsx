// Hero — Z-pattern. Eyebrow → H1 → subhead → CTA + trust banner on the left;
// before/after image placeholder on the right. The image's diagonal split
// pulls the reader's eye back toward the CTA.
...
// Diagonal-split before/after placeholder. The dirty side is top-left, clean
// is bottom-right — that diagonal directs the eye back to the CTA on the left.
// TODO: Replace with real before/after of an OP two-story home, north side,
// algae streaks visible on the BEFORE half, clean siding on the AFTER half.
function BeforeAfterPlaceholder() {
  return (
    <div
      className="relative w-full overflow-hidden rounded-2xl shadow-xl ring-1 ring-black/5"
      style={{ aspectRatio: "4 / 5" }}
      aria-label="Before and after photo of an Overland Park home — algae-streaked siding on the left, freshly soft-washed siding on the right"
      role="img"
    >
      {/* BEFORE half — muted greenish-gray, algae feel */}
      <div
        className="absolute inset-0"
        style={{
          background:
            "linear-gradient(135deg, #6B7565 0%, #58614F 45%, #4F5847 60%, #444C3D 100%)",
          clipPath: "polygon(0 0, 100% 0, 0 100%)",
        }}
      />
      {/* AFTER half — clean warm tan/cream, freshly washed feel */}
      <div
        className="absolute inset-0"
        style={{
          background:
            "linear-gradient(135deg, #E8DDC4 0%, #D9C9A6 45%, #C9B689 60%, #B8A475 100%)",
