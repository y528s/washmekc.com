// Three-column benefits grid with full-bleed white background to break
// from the warm off-white page color.

import React from 'react';
import { motion } from 'framer-motion';
import { Droplets, BadgeCheck, MapPin } from 'lucide-react';
import { FadeInUp } from './_shared.jsx';
          ...
          {BENEFITS.map((b, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="mt-5 font-display font-bold text-[19px] leading-snug text-ink">{b.title}</h3>
