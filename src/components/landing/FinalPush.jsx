...
import { CtaButton, FadeInUp, scrollToQuote } from './_shared.jsx';

export default function FinalPush() {
  return (
    <section aria-label="Final call to action" className="bg-brand text-bg py-16 sm:py-24 px-5 sm:px-8">
